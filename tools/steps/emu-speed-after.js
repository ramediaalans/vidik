// Замер скорости эмулятора на "быстром мониторе".
// headless Chrome всегда даёт rAF на 60 Гц, поэтому 240 Гц мы подделываем таймером.
// Здесь подмена стоит ДО запуска игры — framePacer должен увидеть 240 Гц и ограничить игру 60 к/с.
...
window.requestAnimationFrame = (cb) => {
  ticks += 1;
  return setTimeout(() => cb(performance.now()), 1000 / 240);
};
