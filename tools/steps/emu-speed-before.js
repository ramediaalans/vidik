// Тот же замер, но с воспроизведением старого поведения: игра стартует на 60 Гц
// (framePacer решает, что ограничивать нечего), а потом монитор "разгоняется" до 240 Гц.
// Так выглядел баг: один кадр игры на каждый кадр монитора.
